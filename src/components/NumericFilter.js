...
const renderFilterSelected = (
  ...
  >
    ...
    <button
      ...
      value={num.column}
      onClick={(e) =>
        onExcludeFilter(e.target.value)
      }
      type='button'
    >
      X
...
const renderComparisonSelected = (
  comparisonArray,
  setComparison,
) => (
  <select
