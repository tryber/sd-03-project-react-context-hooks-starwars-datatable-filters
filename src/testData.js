  ...
  results: [
    {
      ...
      url:
        'https://swapi-trybe.herokuapp.com/api/planets/1/',
    },
    {
      name: 'Alderaan',
      rotation_period: '24',
      ...
      url:
        'https://swapi-trybe.herokuapp.com/api/planets/2/',
    },
    {
      name: 'Yavin IV',
      rotation_period: '24',
      ...
      url:
        'https://swapi-trybe.herokuapp.com/api/planets/3/',
    },
    {
      name: 'Hoth',
      rotation_period: '23',
      ...
      url:
        'https://swapi-trybe.herokuapp.com/api/planets/4/',
    },
    {
      name: 'Dagobah',
      rotation_period: '23',
      ...
      url:
        'https://swapi-trybe.herokuapp.com/api/planets/5/',
    },
    {
      name: 'Bespin',
      rotation_period: '12',
      ...
      url:
        'https://swapi-trybe.herokuapp.com/api/planets/6/',
    },
    {
      name: 'Endor',
      rotation_period: '18',
      ...
      url:
        'https://swapi-trybe.herokuapp.com/api/planets/7/',
    },
    {
      name: 'Naboo',
      rotation_period: '26',
      ...
      url:
        'https://swapi-trybe.herokuapp.com/api/planets/8/',
    },
    {
      name: 'Coruscant',
      rotation_period: '24',
      ...
      url:
        'https://swapi-trybe.herokuapp.com/api/planets/9/',
    },
    {
      name: 'Kamino',
      rotation_period: '27',
      ...
      url:
        'https://swapi-trybe.herokuapp.com/api/planets/10/',
    },
  ],
};
